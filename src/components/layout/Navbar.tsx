...
export default function Navbar({updatedCart} : {updatedCart: Item[]}) {
        ...
        <div className="w-full h-16 flex items-center justify-between px-10 py-5 text-2xl fixed z-20 bg-white">
            <div className="flex">
                <Sheet>
                    ...
                    <SheetContent className="bg-white border-none pt-14 min-w-fit w-72" side={"left"}>
                        <SheetHeader>
                            <Button asChild
                                    className="rounded min-h-12 py-7 bg-black text-white text-lg hover:bg-gray-950 duration-200">
                                <Link to={"/register"}>Inscription</Link>
                            </Button>
                            <Button asChild
                                    className="rounded min-h-12 py-7 bg-gray-100 text-lg duration-200 hover:bg-gray-300 mt-20">
                                <Link to={"/login"}>Connexion</Link>
                            </Button>
                            <SheetDescription className="flex flex-col gap-3 py-3 font-semibold">
            ...
            <ToggleGroup type={"single"} className="flex bg-gray-100 rounded-full px-5 mx-5 h-10">
                <ToggleGroupItem className="text-gray-500 aria-checked:text-gray-800 aria-checked:font-bold size-fit p-1 rounded-full min-w-28"
