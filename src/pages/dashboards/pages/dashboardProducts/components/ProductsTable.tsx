...
export default function ProductsTable({products, onEditClick, onDeleteClick}: {
    products: Product[],
                        ...
                        <TableCell>
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                    ...
                                    <ConfirmationModal
                                        description={"Voulez vous vraiement supprimer ce produit?"}
                                        title={"Êtes vous sur?"}
                                        continueText={"Oui"}
                                        cancelText={"Non"}
                                        cancelChanges={() => onDeleteClick(product)}
                                    >
                                        <div
