...
export default function ImageUpload({file, onChange}: FileUploaderProps) {
    ...
    const handleRemoveClick = useCallback(
        () => onChange({uuid: file.uuid, cdnUrl: "/public/assets/image_placeholder.png"}),
        [file, onChange],
    );
                ...
                {file ?
                    <div className={"relative"}>
                        <img
                            ...
                            key={file.uuid}
                            src={file.cdnUrl?.includes("http") ? `${file.cdnUrl}/` : "/public/assets/image_placeholder.png"}
                            height="300"
                            width="300"
                            alt="profile image"
                            title="profile image"
                    ...
                    <img
                        className="aspect-square w-full rounded-md object-cover"
                        src="/public/assets/image_placeholder.png"
                        height="300"
                        width="300"
